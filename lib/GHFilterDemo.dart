...
class GHFilterDemo extends StatefulWidget {
  ...
  GHFilterDemo({Key key, this.arguments}) : super(key: key);
...
class _GHFilterDemoState extends State<GHFilterDemo> {
  ...
  void _loadData() async {
    ...
    var url = "https://a4cj1hm5.api.lncld.net/1.1/classes/" +
        "shopGoodsList?limit=10&&skip=${this._skip}&&order=${this._isSales},${this._isPrice},${"createdAt"}&&where=${parameterWherePrice}";
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Container(
                            child: Column(
                              children: <Widget>[
                                _sideSectionTitle("容量", this._thirdList),
  ...
  Widget _customAppbar(context) {
    return GHCustomAppbar(
      contentHeight: ScreenUtil.bottomBarHeight,
